...
# 导入Moore专用组件
from world_model import MooreWorldModel
from train_moore_agent import MooreTDMPC2, update_cfg_from_env
...
def _warm_up_inductor(world_model, cfg):
    ...
    with torch.no_grad(), torch.cuda.amp.autocast():
        ...
        # 触发四条核心路径的编译
        world_model.dynamics_step(z, a)           # 使用dynamics_step代替next
...
def train(cfg):
    ...
    # 初始化组件
    from renew.trainer.offline_trainer import OfflineTrainer
    from renew.trainer.online_trainer import OnlineTrainer
